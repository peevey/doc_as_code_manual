...
Dahinter steht eine Philosophie, den man als "Doc as Code" bezeichnet. Das heißt: Schreibe deine Dokumentation mit denselben Methoden und Tools wie deinen Programmcode.

Diese Vorgehensweise hat verschiedene Vorteile: Sie bringt das
